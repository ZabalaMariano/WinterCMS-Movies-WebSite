...
class SimpleContact extends ComponentBase
{
    ...
    public function onFormSubmit(){
        ...
        if(Settings::get('redirect_to_page',false) && !empty(Settings::get('redirect_to_url','')))
            ...
            Flash::success(Settings::get('success_message','Gracias por contactarnos. Le responderemos en los próximos días.'));
    ...
    protected function submitForm(){
        ...
        if(Settings::get('recieve_notification',true) && !empty(Settings::get('notification_email_address',env('MAIL_TO_ADDRESS'))))
